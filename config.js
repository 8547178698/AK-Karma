...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Devutty public bot' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'DEVU MWOL' : process.env.BOT_NAME,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'https://i.ibb.co/9rrnJ7g/Devutty.jpg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Devutty' : process.env.TAG_HEADER,
